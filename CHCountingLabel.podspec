#
#  Be sure to run `pod spec lint CHCountingLabel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
Your counting only increase/decrease 1 progress per seconds?
...
Use CHCountingLabel and make more fantasy effect to your app.
  ...
  s.screenshots  = ['https://dl.dropboxusercontent.com/u/108987767/blog/16/easeinout_counting_1.gif', 'https://dl.dropboxusercontent.com/u/108987767/blog/16/easeinout_counting_2.gif']
